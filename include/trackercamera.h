...
namespace DaveTracker2{
    ...
    class TrackerCamera : public DaveCamera2::Camera{
        // Extends the DaveCamera2 basic camera wrapper for the uEye driver.
        ...
        public:
            ...
            bool Spot_Finder(DaveCamera2::Subpixel_Values& spot_Coords);
            #ifdef HAVE_OPENCV
        ...
        private:
            ...
            int Make_Opencv_Mat(DaveCamera2::AOI my_AOI);
            ...
            // AOI.
            int Draw_Spot(DaveCamera2::Subpixel_Values spot_Position, cv::Scalar colour);
            int Draw_AOI(DaveCamera2::AOI my_AOI);
            ...
            DaveCamera2::Subpixel_Values my_Spot_Coords;
